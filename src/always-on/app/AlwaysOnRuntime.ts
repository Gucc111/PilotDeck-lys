...
import { GitWorktreeProvider } from "../phases/workspace/GitWorktreeProvider.js";
import { SnapshotCopyProvider } from "../phases/workspace/SnapshotCopyProvider.js";
...
import { ChannelLeaseRegistry } from "../orchestration/ChannelLeaseRegistry.js";
import { AlwaysOnPipeline, type AlwaysOnPipelineDependencies } from "../orchestration/AlwaysOnPipeline.js";
import { DiscoveryScheduler } from "../orchestration/DiscoveryScheduler.js";
...
export type CreateAlwaysOnRuntimeOptions = {
  ...
  disableAlwaysOnProject?: AlwaysOnPipelineDependencies["disableAlwaysOnProject"];
};
...
export class AlwaysOnRuntime {
  ...
  private readonly onTurnEvent?: AlwaysOnPipelineDependencies["onTurnEvent"];
  private readonly telemetry?: TelemetryClient;
  private readonly preferenceLlm?: PreferenceLlmOptions;
  private readonly disableAlwaysOnProject?: AlwaysOnPipelineDependencies["disableAlwaysOnProject"];

  private gateway?: Gateway;
  private fire?: AlwaysOnPipeline;
  ...
  bindGateway(
    ...
    this.fire = new AlwaysOnPipeline({
      config: this.config,
      paths: this.paths,
      projectKey: this.projectKey,
      gateway,
