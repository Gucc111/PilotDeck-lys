...
export class AgentLoop {
  ...
  private async createModelRequest(
    ...
    return {
      ...
      temperature: input.modelOverride ? input.modelOverride.temperature : this.config.temperature,
      thinking: input.modelOverride ? input.modelOverride.thinking : this.config.thinking,
      stream: true,
